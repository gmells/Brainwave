         ...
         border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]"
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            >
             ...
             bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15"
              >
                <h4 className="h4 mb-4">Photo editing</h4>
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photos by using our AI app&apos;s
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <p className="body-2 text-[2rem] text-n-3">
                  The world&apos;s most powerful AI photo and video art
                  generation engine. What will you create?
                </p>

                <ul className="flex items-center justify-between rounded-2xl">
                  {brainwaveServicesIcons.map((item, index) => (
                    <li
                      key={index}
                      className={`flex items-center justify-center ${
                        index === 2
                          ? "w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-[4.5rem]"
