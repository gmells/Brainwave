...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 lg:bg-n-8/90 
      lg:backdrop:blur-sm border-b border-n-6 ${
      ...
      >
        ...
        >
          <div
            ...
            justify-center lg:flex-row m-auto"
          >
            {navigation.map((item) => (
              <a
                key={item.id}
                ...
                onClick={handleClick}
                className={`block 
              relative font-code text-2xl uppercase text-n-1
